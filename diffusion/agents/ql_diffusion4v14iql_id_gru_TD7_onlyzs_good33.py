...
from diffusion.agents.meta_diffusion_id_TD7_onlyzs_good33 import Diffusion
...
class Diffusion_QL(object):
    def __init__(self,
        ...
        # self.encoder = torch.load('/home/czy/meta/Meta_diffusion_QL/TD7/goodin33big/encoder_310.0.pt').to(args.device).eval()
